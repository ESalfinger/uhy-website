<div class="bg-white pt-5 pb-3 sticky top-0 z-40 transition-all" x-data="{mega_nav: 0}" @scroll.window="scrolled = (window.pageYOffset <= 50) ? false : true">
  <div class="relative" x-data="{'burgerOpen': false}" x-cloak>
